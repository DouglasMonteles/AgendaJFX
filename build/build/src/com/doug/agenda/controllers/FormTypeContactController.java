...
import com.doug.agenda.utils.ValidField;
...
public class FormTypeContactController implements Initializable, IRegister {
    ...
    void deleteRegister(ActionEvent event) {
    	if (TypeContactDao.freeDelete(typeContactSelected.getId())) {
    		...
    		Alert.informationAlert("Não permitido!\n"
    				+ "Esse tipo de contato está sendo utilizado na tabela de Contato");
    	}
    }
    ...
    void saveRegister(ActionEvent event) {
    	if (ValidField.checkEmptyField(tfDescription)) {
